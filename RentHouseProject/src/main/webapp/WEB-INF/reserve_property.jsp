			...
			<div class="row">
				<div class="col-lg-4" style="display: flex;">
					...
					<div class="products__filter mb-30" style="margin-top: 30px">
						<div class="products__filter__group"></div>
					...
					<img src="images/<c:out value="${property.image}"></c:out>"
						alt="image_not_found" style="width: 300px">
					<div
								...
								<div class="col-md-6 col-lg-6">
									<div class="card__image card__box-v1">
										...
										<div class="card__image-body">
											...
											description:
											 <c:out
															value="${property.description} ft"></c:out>
										</div>
											...
											<ul class="list-inline my-auto">
												<li class="list-inline-item">
													<form action="/property/reserve/${property.id}"
														...
														<p>
															Start Reservation Date: <input type="date"
																name="startReserveDate">
														</p>
														<p>
															End Reservation Date: <input type="date"
																name="endReserveDate">
														</p>
														<input type="hidden" name="${_csrf.parameterName}"
