...
<!-- END NAVBAR TOP -->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="main_nav99">
            ...
            <ul class="navbar-nav">
                <li>
                    <a class="ree" href="/login">Login |</a>
                    <a class="ree" href="/registration">Register</a>
        ...
        <form:form method="POST" action="/registration" modelAttribute="user">
            ...
            <div class="form-group">
                <label class="custom-control custom-radio custom-control-inline">
                    <input class="custom-control-input" type="radio" name="role" value="CLIENT">
                    <span class="custom-control-label"> Client </span>
                </label>
                <label class="custom-control custom-radio custom-control-inline">
                    <input class="custom-control-input" type="radio" name="role" value="OWNER">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-lg-6">
                    <label>City</label>
             	<form:select name="city" id="city" path="city" class="form-control">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <form:label path="passwordConfirmation">Repeat Password:</form:label>
